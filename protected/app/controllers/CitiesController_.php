...
class CitiesController extends BaseController {
    ...
    public function getData($slug){  
        ...
        $aggregate_statistics[3] = ['value' => 0, 'title' => 'TOTAL VACANCY', 'sub_title' => '', 'prefix' => '', 'postfix' => '%', 'class' => 'h2-big', 'font_size' => ''];
        $aggregate_statistics[4] = ['value' => 0, 'title' => 'DIRECT VACANCY', 'sub_title' => '(s.f.)', 'prefix' => '', 'postfix' => '', 'class' => 'h2-small', 'font_size' => ''];
        $aggregate_statistics[5] = ['value' => 0, 'title' => 'DIRECT VACANCY', 'sub_title' => '', 'prefix' => '', 'postfix' => '%', 'class' => 'h2-big', 'font_size' => ''];
        $aggregate_statistics[6] = ['value' => 0, 'title' => 'OCCUPANCY', 'sub_title' => '(s.f.)', 'prefix' => '', 'postfix' => '', 'class' => 'h2-small', 'font_size' => ''];
        $aggregate_statistics[7] = ['value' => 0, 'title' => 'OCCUPANCY RATE', 'sub_title' => '', 'prefix' => '', 'postfix' => '%', 'class' => 'h2-big', 'font_size' => ''];
        $aggregate_statistics[8] = ['value' => 0, 'title' => 'TOTAL LEASED', 'sub_title' => '', 'prefix' => '', 'postfix' => '%', 'class' => 'h2-big', 'font_size' => ''];
        ...
        if($skyline_buildings){
            ...
            foreach ($skyline_buildings->building as $key => $value) {
                ...
                $aggregate_statistics[9]['value'] +=  $value->i_leased * $value->i_rba;
            ...
            $aggregate_statistics[3]['value'] = round($aggregate_statistics[2]['value'] / $aggregate_statistics[0]['value'], 2);
            $aggregate_statistics[5]['value'] = round($aggregate_statistics[4]['value'] / $aggregate_statistics[0]['value'], 2);
    
            $aggregate_statistics[7]['value'] = round($aggregate_statistics[6]['value'] / $aggregate_statistics[0]['value'], 2);
            
            $aggregate_statistics[8]['value'] = round(@$aggregate_statistics[9]['value'] / $aggregate_statistics[0]['value'], 2);
            $aggregate_statistics[9]['value'] = round($aggregate_statistics[9]['value'], 1);
            $aggregate_statistics[3]['value'] = round($aggregate_statistics[3]['value'], 1);
            $aggregate_statistics[11]['value']= round($aggregate_statistics[11]['value'], 1);
        }
        
        //print_r($aggregate_statistics);exit;
