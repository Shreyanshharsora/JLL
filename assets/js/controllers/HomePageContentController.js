...
app.controller('HomePageContentController', function($filter,$rootScope, $scope, $http, $timeout, PaginationService, GLOBAL, mySharedService, $state, $stateParams) {
    ...
    $rootScope.selectedType = {name:'Image'};
    $rootScope.linkType= {name:'NewTab'};
    ...
    $scope.$on('$viewContentLoaded', function() {
        ...
        PaginationService.loading(GLOBAL.API_URL+"home-page-content","v_box_asc_no",'asc');
    });
    ...
    $rootScope.frm_edit_open = function(item)
    {
        ...
        $rootScope.selectedType.name= item.v_video != "" ?'Video':'Image';
        $rootScope.linkType.name= item.e_link_open;
...
//                                }
    ...
    $rootScope.submit_frm_edit = function(edit_fields){
		...
		edit_fields['selectedType'] = $rootScope.selectedType.name;
        edit_fields['linkType'] = $rootScope.linkType.name;
