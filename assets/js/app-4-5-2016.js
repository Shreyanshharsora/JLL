...
app.config(['$stateProvider', '$urlRouterProvider', '$locationProvider','$interpolateProvider','GLOBAL', function($stateProvider, $urlRouterProvider, $locationProvider,$interpolateProvider, GLOBAL) {
    ...
    $stateProvider
        ...
        .state('/users-view', {
            url: "/users/view/:id",
            templateUrl: ADMIN_ASSET_URL+"templates/users-view.html",
            data: { pageTitle: 'Edit User', pageHead: 'Edit User', currTab: 'users'},
            onEnter: function($state, $stateParams, GlobalVariables, $location)
            {
                if(GLOBAL.checkId.toString() == 'false'){ 
        ...
        .state('/my_profile', {
            url: "/my_profile",
            templateUrl: ADMIN_ASSET_URL+"templates/my_profile.html",
        ...
        .state('/buildings', {
            url: "/buildings",
            templateUrl: ADMIN_ASSET_URL+"templates/buildings.html",
        ...
        .state('/buildings-add', {
            url: "/buildings/add",
            templateUrl: ADMIN_ASSET_URL+"templates/buildings-add.html",
        ...
        .state('/buildings-edit', {
            ...
            templateUrl: ADMIN_ASSET_URL+"templates/buildings-edit.html",
        ...
        .state('/buildings-add1', {
            url: "/buildings/add1",
            templateUrl: ADMIN_ASSET_URL+"templates/buildings-add1.html",
        ...
        .state('/buildings-edit1', {
            ...
            templateUrl: ADMIN_ASSET_URL+"templates/buildings-edit1.html",
        ...
        .state('/buildings-add2', {
            url: "/buildings/add2",
            templateUrl: ADMIN_ASSET_URL+"templates/buildings-add2.html",
            controller: "BuildingsAdd1Controller",
            data: { pageTitle: 'Add Building', pageHead: 'Add Building', currTab: 'buildings'},
            onEnter: function($state, $stateParams, GlobalVariables, $location)
            {
        ...
        .state('/buildings-edit2', {
            ...
            templateUrl: ADMIN_ASSET_URL+"templates/buildings-edit2.html",
            controller: "BuildingsEdit1Controller",
            data: { pageTitle: 'Edit Building', pageHead: 'Edit Building', currTab: 'buildings'},
            onEnter: function($state, $stateParams, GlobalVariables, $location)
            {
        ...
        .state('/buildings/set-order', {
            ...
            templateUrl: ADMIN_ASSET_URL+"templates/buildings-order.html",
        ...
        .state('/cms', {
            url: "/cms",
            templateUrl: ADMIN_ASSET_URL+"templates/cms.html",
        ...
        .state('/cms-add', {
            url: "/cms/add",
            templateUrl: ADMIN_ASSET_URL+"templates/cms-add.html",
        ...
        .state('/cms-edit', {
            url: "/cms/edit/:id",
            templateUrl: ADMIN_ASSET_URL+"templates/cms-edit.html",
        ...
        .state('/cities', {
            url: "/cities",
            templateUrl: ADMIN_ASSET_URL+"templates/cities.html",
        ...
        .state('/cities-add', {
            url: "/cities/add",
            templateUrl: ADMIN_ASSET_URL+"templates/cities-add.html",
        ...
        .state('/cities-edit', {
            url: "/cities/edit/:id",
            templateUrl: ADMIN_ASSET_URL+"templates/cities-edit.html",
        ...
        .state('/unit-status', {
            url: "/unit-status",
            templateUrl: ADMIN_ASSET_URL+"templates/unit_status.html",
        ...
        .state('/unit-status-add', {
            url: "/unit-status/add",
            templateUrl: ADMIN_ASSET_URL+"templates//unit-status-add.html",
        ...
        .state('/unit-status-edit', {
            ...
            templateUrl: ADMIN_ASSET_URL+"templates/unit-status-edit.html",
        ...
        .state('/national-asset', {
            url: "/national-asset",
            templateUrl: ADMIN_ASSET_URL+"templates/national-asset.html",
        ...
        .state('/national-asset-add', {
            ...
            templateUrl: ADMIN_ASSET_URL+"templates/national-asset-add.html",
        ...
        .state('/national-asset-edit', {
            ...
            templateUrl: ADMIN_ASSET_URL+"templates/national-asset-edit.html",
        ...
        .state('/city-asset', {
            url: "/city-asset",
            templateUrl: ADMIN_ASSET_URL+"templates/city-asset.html",
        ...
        .state('/city-asset-add', {
            url: "/city-asset/add",
            templateUrl: ADMIN_ASSET_URL+"templates/city-asset-add.html",
        ...
        .state('/city-asset-edit', {
            ...
            templateUrl: ADMIN_ASSET_URL+"templates/city-asset-edit.html",
        ...
        .state('/settings', {
            url: "/settings",
            templateUrl: ADMIN_ASSET_URL+"templates/settings.html",
        ...
        .state('/domains', {
            url: "/domains",
            templateUrl: ADMIN_ASSET_URL+"templates/domains.html",
        ...
        .state('/domains-add', {
            url: "/domains/add",
            templateUrl: ADMIN_ASSET_URL+"templates/domains-add.html",
        ...
        .state('/domains-edit', {
            url: "/domains/edit/:id",
            templateUrl: ADMIN_ASSET_URL+"templates/domains-edit.html",
		...
		.state('/custom-skyline', {
            url: "/custom-skyline",
            templateUrl: ADMIN_ASSET_URL+"templates/custom-skyline.html",
        ...
        .state('/custom-skyline-view', {
            ...
            templateUrl: ADMIN_ASSET_URL+"templates/custom-skyline-view.html",
        ...
        .state('/home-banner', {
            url: "/home-banner",
            templateUrl: ADMIN_ASSET_URL+"templates/home-page-banners.html",
         ...
         .state('/home-banner-add', {
            url: "/home-banner/add",
            templateUrl: ADMIN_ASSET_URL+"templates/home-page-banners-add.html",
        ...
        .state('/home-banner-edit', {
            ...
            templateUrl: ADMIN_ASSET_URL+"templates/home-page-banners-edit.html",
        ...
        .state('/home-image-rotator', {
            ...
            templateUrl: ADMIN_ASSET_URL+"templates/home-page-image-rotation.html",
         ...
         .state('/home-image-rotator-add', {
            ...
            templateUrl: ADMIN_ASSET_URL+"templates/home-page-image-rotation-add.html",
        ...
        .state('/home-image-rotator-edit', {
            ...
            templateUrl: ADMIN_ASSET_URL+"templates/home-page-image-rotation-edit.html",
        ...
        .state('/home-content', {
            url: "/home-content",
            templateUrl: ADMIN_ASSET_URL+"templates/home-page-content.html",
            data: { pageTitle: 'Home Page Content Block', pageHead: 'Home Page Content Block', currTab: 'home_page_content'},
         ...
         .state('/home-content-add', {
            ...
            templateUrl: ADMIN_ASSET_URL+"templates/home-page-content-add.html",
            data: { pageTitle: 'Add Home Page Content Block', pageHead: 'Add Home Page Content Block', currTab: 'home_page_content'},
        ...
        .state('/home-content-edit', {
            ...
            templateUrl: ADMIN_ASSET_URL+"templates/home-page-content-edit.html",
            data: { pageTitle: 'Edit Home Page Content Block', pageHead: 'Edit Home Page Content Block', currTab: 'home_page_content'},
            onEnter: function($state, $stateParams, GlobalVariables, $location)
            {
                if(GLOBAL.checkId.toString() == 'false'){ 
                    GlobalVariables.intended_url = $location.path(); 
